...
public class FrameSobre extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        setTitle("Sobre Sistema Agenda...");
        setModal(true);

        jLabel2.setText("Sistema de Agenda Telefônica  Versão 0.01");

        jLabel3.setText("Estácio | FIC - 2014");

        jLabel4.setText("Programador: Newton Gomes");
